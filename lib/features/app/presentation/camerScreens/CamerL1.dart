...
class CameraScreenL1 extends StatefulWidget {
  ...
  @override
  State<CameraScreenL1> createState() => _CameraScreenL1State();
}

class _CameraScreenL1State extends State<CameraScreenL1> {
  String? AssetVide;
  ...
  void initState() {
    ...
    _videoPlayerController = VideoPlayerController.asset('video/O2.mp4'
      //??
      // 'video/smile.mp4'
    )
      ..initialize().then((_) {
                          ...
                          actions: [
                            CircularCountDownTimer(
                              ...
                              onComplete: () async{
                                ...
                                gameData.score = gameData.score + cubit.Rcounter;
                                box.put('game_data', gameData);
FaceDetectionCubit().takeScreenshotAndSave();
