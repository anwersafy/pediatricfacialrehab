...
class CameraScreenL3 extends StatefulWidget {



  @override
  State<CameraScreenL3> createState() => _CameraScreenL3State();
}

class _CameraScreenL3State extends State<CameraScreenL3> {
  String? AssetVide;
  ...
  void initState() {
    ...
    _videoPlayerController = VideoPlayerController.asset('video/madmada5_.mp4'
      //??
      // 'video/smile.mp4'
    )
      ..initialize().then((_) {
