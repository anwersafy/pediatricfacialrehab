...
class CameraScreenL4 extends StatefulWidget {


  @override
  State<CameraScreenL4> createState() => _CameraScreenL4State();
}

class _CameraScreenL4State extends State<CameraScreenL4> {
  String? AssetVide;
  ...
  void initState() {
    ...
    _videoPlayerController = VideoPlayerController.asset('video/karmasha6.mp4'
      //??
      // 'video/smile.mp4'
    )
      ..initialize().then((_) {
