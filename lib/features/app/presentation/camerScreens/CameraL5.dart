...
class CameraScreenL5 extends StatefulWidget {


  @override
  State<CameraScreenL5> createState() => _CameraScreenL5State();
}

class _CameraScreenL5State extends State<CameraScreenL5> {
  String? AssetVide;
  ...
  void initState() {
    ...
    _videoPlayerController = VideoPlayerController.asset('video/Blown3.mp4'
      //??
      // 'video/smile.mp4'
    )
      ..initialize().then((_) {
